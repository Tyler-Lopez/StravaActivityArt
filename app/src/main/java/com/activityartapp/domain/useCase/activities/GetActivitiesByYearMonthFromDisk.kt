...
/**
 * Retrieves all [Activity] stored on disk associated with an
 * [AthleteCacheDictionary] occurring on the given year and month.
 */
class GetActivitiesByYearMonthFromDisk @Inject constructor(
